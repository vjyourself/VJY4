package vjyourself4.ctrl{
	...
	public class GamepadExp{
		...
		var gamepad;
		public var inputMode:String="GamepadSingleSimple";
		public function GamepadExp(){}
		...
		public function init(){
			switch(inputMode){
				...
				break;
				case "GamepadSingleSimple":
				gamepad = new GamepadSingleSimple();
				gamepad.ns=ns;
				gamepad.init();
				gamepad.events.addEventListener("Trig",onTrig);
				break;
		...
		*/
		public function onEF(e){
			switch(inputMode){
				...
				ns.scene.anal.setInput(0,gamepad.anal[0][0]);
				ns.scene.anal.setInput(1,gamepad.anal[0][1]);
				ns.scene.anal.setInput(2,gamepad.anal[0][2]);
				ns.scene.anal.setInput(3,gamepad.anal[0][3]);

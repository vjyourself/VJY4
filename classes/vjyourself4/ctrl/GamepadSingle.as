package vjyourself4.ctrl{
	...
	public class GamepadSingle{
		...
		public function init(){
			...
			if(analPage_num>1) gamepadManager.events.addEventListener("Gamepad0_"+analPage_butt,onPageAnal,0,0,1);
			if(trigPage_num>1) gamepadManager.events.addEventListener("Gamepad0_"+trigPage_butt,onPageTrig,0,0,1);
		...
		function getPageAnal():int{
			...
			if(analPage_mode=="combo") {
				var s=gamepadManager.getState(0);
		...
		*/
		...
		public function onEF(e){
			process(getPageAnal(),gamepadManager.getState(0));
		}
		...
		public function dispose(){
			if(analPage_num>1) gamepadManager.events.removeEventListener("Gamepad0_"+analPage_butt,onPageAnal);
			if(trigPage_num>1) gamepadManager.events.removeEventListener("Gamepad0_"+trigPage_butt,onPageTrig);

package vjyourself4.three
{
	 ...
	 */
	public class CubeGeometryDouble extends PrimitiveBase
	{
		 ...
		 */
		public function CubeGeometryDouble(width : Number = 100, height : Number = 100, depth : Number = 100,
		...
		protected override function buildGeometry(target : CompactSubGeometry):void
		{
			...
			if (numVerts == target.numVertices) {
				...
				indices = new Vector.<uint>((_segmentsW*_segmentsH + _segmentsW*_segmentsD + _segmentsH*_segmentsD)*12*2, true);
			}

package vjyourself4.three
{
	 ...
	 */
	public class WireframeRandomCylinder extends WireframePrimitiveBase
	{
		 ...
		 */
		public function WireframeRandomCylinder(topRadius:Number = 50, bottomRadius:Number = 50, height:Number = 100, segmentsW:uint = 16, segmentsH:uint = 1, color:uint = 0xFFFFFF, thickness:Number = 1)
		{
		...
		override protected function buildGeometry():void
		{
			...
			for (j = 0; j <= _segmentsH; ++j)
			{
				...
				{
					// revolution vertex
					revolutionAngle = i*revolutionAngleDelta*(1+Math.random()*0.2);
					var rr=(1+Math.random()*0.3)*radius;

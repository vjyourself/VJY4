package vjyourself4.three
{
	...
	public class WireframePlaneData extends WireframePrimitiveBase
	{
		 ...
		 */
		public function WireframePlaneData(width : Number, height : Number, segmentsW : int = 10, segmentsH : int = 10, color:uint = 0xFFFFFF, thickness:Number = 1, orientation : String = "yz") {

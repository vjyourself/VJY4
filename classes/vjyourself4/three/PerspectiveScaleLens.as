package vjyourself4.three
{
	 ...
	 */
	public class PerspectiveScaleLens extends LensBase
	{
		 ...
		 */
		public function PerspectiveScaleLens(fieldOfView:Number = 60, coordinateSystem:uint = 0)
		{
			super();
		...
		override public function project(point3d:Vector3D, v:Vector3D = null):Vector3D
		{
			if(!v) v = new Vector3D();
		...
		{
			var clone:PerspectiveScaleLens = new PerspectiveScaleLens(_fieldOfView);
			clone._near = _near;
			clone._far = _far;

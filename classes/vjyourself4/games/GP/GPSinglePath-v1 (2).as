	...
	public class GPSinglePath{
		...
		public function init(){
			...
			*/
			...
			synthPath.timeline.startSpace(ns._sys.cloud.RPrg.cont.programs.path["Prg"+params.space]);
		...
		*/
		...
		public function setParams(p){
			...
			if(p.space!=null){
				synthPath.timeline.startSpace(ns._sys.cloud.RPrg.cont.programs.path["Prg"+p.space]);
				currSpace=p.space;
			}else if(rstr) synthPath.timeline.startSpace(ns._sys.cloud.RPrg.cont.programs.path["Prg"+currSpace]);
		...
		public function restart(p){
			...
			else synthPath.timeline.startSpace(ns._sys.cloud.RPrg.cont.programs.path["Prg"+currSpace]);
		}
